...
![Features Web](/images/features.webp)
...
## <Icon icon="address-card" color="#ff0303" size={30} />  Intergration Features
...
## <Icon icon="magnifying-glass" color="#00c0ff" size={30} />  Deployment Features
...
## <Icon icon="person-burst" color="#ff0303" size={30} /> Audio Features
...
## <Icon icon="check-to-slot" color="#ff00e2" size={30} /> Speech-to-Text & Privacy Features
...
## <Icon icon="microphone" color="#00ce5d" size={30} /> Tenant & Usages Features
...
## <Icon icon="thought-bubble" color="#ffa000" size={30} /> Data Storage Features
