---
title: "1. Overview of Call-Emma.ai"
...
<CardGroup cols={2}>
  ...
  <Card title="Core Features" icon="flask-gear" color="#0e0dfb">
  ...
  <Card title="System Overview" icon="solar-system" color="#0e0dfb">
  ...
  <Card title="Configuration Options" icon="folder-gear" color="#0e0dfb">
  ...
  <Card title="Demo Video " icon="video" color="#0e0dfb">
  ...
  <Card title="Cost of Usage Example" icon="dollar-sign" color="#0e0dfb">
    See our Live Cost Calculator to determine Running Costs.

    <Icon icon="arrow-right" iconType="regular" color="#595eff" size={17} />  [**<u>Go to Page</u>**](/cost)
  </Card>
  <Card title="Question & Answer" icon="circle-question" color="#0e0dfb">
    Sd

    <Icon icon="arrow-right" iconType="regular" color="#595eff" size={17} />   [**<u>Go to Page</u>**](/q_a)
  </Card>
  <Card title="Brochure" icon="marker" color="#0e0dfb">
    Sd

    <Icon icon="arrow-right" iconType="regular" color="#595eff" size={17} />   [**<u>Go to Page</u>**](/brochure)
  </Card>
</CardGroup>

![Line Web](/images/line.webp)

![Use Cases Web](/images/use-cases.webp)
