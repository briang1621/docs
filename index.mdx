...
description: "Call-Emma.ai is a self-hosted, enterprise-grade, call center software (CCS) integration that designed to delivers generative AI features, such as AI powered insights and analysis, directly to your CCS platform. The solution is scalable, highly configurable, multi-tenant ready, and designed for usage-based billing."
---
...
The 7 categories of use cases below are broken down into a total 27 specific use cases.
...
## <Icon icon="phone-plus" color="#0014fa" size={24} />  Call Details
